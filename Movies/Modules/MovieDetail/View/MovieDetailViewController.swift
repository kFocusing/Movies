...
class MovieDetailViewController: BaseViewController {
    ...
    private func layoutTitleLabel() {
        NSLayoutConstraint.activate([
            titleLabel.topAnchor.constraint(equalTo: posterImage.bottomAnchor, constant: verticalInset),
    ...
    private func layoutPropertiesLabel() {
        NSLayoutConstraint.activate([
            propertiesLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: verticalInset),
            propertiesLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalInset),
            propertiesLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalInset)
        ])
    }
    
    private func layoutGenresLabel() {
        NSLayoutConstraint.activate([
            genresLabel.topAnchor.constraint(equalTo: propertiesLabel.bottomAnchor, constant: verticalInset),
            genresLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalInset),
            genresLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalInset)
        ])
    }
    ...
    private func layoutRatingLabel() {
        NSLayoutConstraint.activate([
            ...
            ratingLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalInset)
        ])
    }
    
    private func layoutTrailerButton() {
        NSLayoutConstraint.activate([
            trailerButton.topAnchor.constraint(equalTo: genresLabel.bottomAnchor, constant: verticalInset),
            trailerButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalInset),
    ...
    private func layoutDescriptionLabel() {
        NSLayoutConstraint.activate([
            descriptionLabel.topAnchor.constraint(equalTo: trailerButton.bottomAnchor, constant: verticalInset),
            descriptionLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalInset),
            descriptionLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalInset)
        ])
    }
